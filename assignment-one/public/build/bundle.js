...
var app = (function () {
    ...
    /* src/Goal.svelte generated by Svelte v3.42.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text("GOAL: ");
    			t1 = text(/*goal*/ ctx[0]);
    			attr_dev(h1, "class", "svelte-pdgu8");
    			toggle_class(h1, "red__text", /*goal*/ ctx[0].includes('!!!'));
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t13 = space();
    			input = element("input");
    			add_location(h1, file, 7, 2, 83);
    			add_location(p, file, 9, 2, 106);
    			add_location(li0, file, 12, 4, 144);
    			add_location(li1, file, 13, 4, 218);
    			add_location(li2, file, 14, 4, 266);
    			add_location(li3, file, 17, 4, 383);
    			add_location(ol, file, 11, 2, 135);
    			add_location(hr, file, 22, 2, 498);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 26, 2, 524);
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, hr);
    			append_dev(main, t12);
    			mount_component(goal_1, main, null);
    			append_dev(main, t13);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*goal*/ 1) goal_1_changes.goal = /*goal*/ ctx[0];
